---
name: humanizer
description: "humanizer, rewrite, AI-generated, AI slop, prose, editing, inflated claims, sales language, vague sources, stock AI words, passive voice, filler, chatbot artifacts, 去除 AI 味, 這段像 AI 寫的, 潤稿, 讓它像人寫的"
license: MIT
metadata:
  version: "2.11.1"
...
flagging anything.** The titles below are only an index: they tell you a pattern
exists, not how to tell it apart from a person writing that way on purpose, and
that distinction is the whole job. Cited by number throughout this file (§7,
§14, ...).
